    ...
    return (
      (() => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.AttachAddon = void 0),
          (t.AttachAddon = class {
            constructor(e, t) {
              (this._disposables = []),
                (this._socket = e),
                (this._socket.binaryType = "arraybuffer"),
                (this._bidirectional = !(t && !1 === t.bidirectional));
            }
            activate(e) {
              this._disposables.push(
                s(this._socket, "message", (t) => {
                  const s = t.data;
                ...
                this._bidirectional &&
                  ...
                  this._disposables.push(
                    e.onBinary((e) => this._sendBinary(e))
                  )),
                this._disposables.push(
                  s(this._socket, "close", () => this.dispose())
                ),
                this._disposables.push(
                  s(this._socket, "error", () => this.dispose())
                );
            }
            dispose() {
